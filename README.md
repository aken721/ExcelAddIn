...
**2025-11-08**
v2.4.6.1 主要更新内容：
1. 这里是列表文本增加pdf（或图片）电子发票的数据提取功能，采用PaddleOCR进行图像识别，可批量提取pdf格式或图片格式的电子发票信息到excel表格；新功能支持电子发票的批量管理，结合以前已上线的xml数电票管理，基本覆盖了xml、pdf、图片等多种格式的电子发票。
2. 这里是列表文本将2.4.5.2新增功能一并打包，发布v2.4.6.1安装版。
